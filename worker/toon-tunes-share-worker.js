  ...
  async fetch(request, env) {
    ...
    try {
      ...
      if (isPlaylist) {
        ...
        finalDesc = `Listen to this curated collection featuring ${title} by ${artist} and more on Mukesh Music 4u.`;
      } else {
        finalTitle = `${title} | Mukesh Music 4u`;
